...
# This fixes docker-compose failing with 
# "1 error occurred: * error getting credentials - err: exit status 1, out: `exit status 2: gpg: decryption failed: No secret key`"
export GPG_TTY=$(tty)
